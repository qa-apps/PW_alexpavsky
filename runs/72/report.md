...
_Generated: 2026-07-18T18:45:42.760223+00:00_
...
| Average answer_relevancy | 0.757 | ≥ 0.55 | PASS |
...
| finnova-13-test-generator-agent | agents | 0.80 | 0.96 | PASS | The **Test Generator** agent (Agent 1) is responsible for **generating Playwright + TypeScript autom... |
| finnova-14-rag-quality-gate | agents | 1.00 | 0.80 | PASS | Based on the provided context, **Agent 3 - RAG Quality Gate** is designed to validate LLM-powered cu... |
...
| concept-04-page-object-model | best-practices | 1.00 | 0.91 | PASS | The **classic Page Object Model (POM)** tends to create large, monolithic page objects that encapsul... |
