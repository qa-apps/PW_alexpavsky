...
_Generated: 2026-07-16T18:55:20.233649+00:00_
...
| Average answer_relevancy | 0.773 | ≥ 0.55 | PASS |
...
| finnova-02-bug-reduction | metrics | 1.00 | 0.98 | PASS | Production bugs at FinNova Bank dropped by **67%**.  (Before: 18.4 P1/P2 incidents per month → After... |
...
| finnova-06-flake-rate | metrics | 1.00 | 0.58 | FAIL | Based on the provided context, the flake rate before implementing the flaky test reduction measures ... |
...
| finnova-10-black-friday | incidents | 1.00 | 0.83 | PASS | During the Black Friday wire transfer outage in November 2024, the FinNova Bank system experienced d... |
...
| finnova-12-kafka-incident | incidents | 0.80 | 0.00 | FAIL | The provided context does not contain any information about a "Data Integrity Verifier" or any event... |
| finnova-13-test-generator-agent | agents | 1.00 | 0.82 | PASS | The Test Generator agent (Agent 1) generates Playwright + TypeScript tests from user stories. Over 1... |
| finnova-14-rag-quality-gate | agents | 0.82 | 1.00 | PASS | Agent 3 - RAG Quality Gate is designed to validate LLM-powered customer support responses against th... |
...
| concept-03-rag-hallucination | best-practices | 0.87 | 0.96 | PASS | To measure and prevent hallucinations in RAG (Retrieval-Augmented Generation) systems, the context e... |
| concept-04-page-object-model | best-practices | 1.00 | 0.85 | PASS | The context explains that the **Component-Driven Page Object Model (POM)** is an optimized variation... |
...
| concept-06-mcp-architecture | best-practices | 0.97 | 0.98 | PASS | The **Model Context Protocol (MCP)** is an open-standard architecture designed to standardize contex... |
| concept-07-flakiness-reduction | best-practices | 0.83 | 1.00 | PASS | Based on the provided context, the most effective strategies to reduce test flakiness in Playwright ... |
| concept-08-kafka-validation | best-practices | 0.63 | 0.93 | PASS | To test event-driven systems with Kafka in distributed environments, the provided context outlines a... |
...
| negative-02-fabrication | refusal | 0.50 | 0.00 | FAIL | The context does not provide information about the number of employees from Anthropic who worked on ... |