...
_Generated: 2026-06-28T18:17:59.962831+00:00_
...
| finnova-11-march-incident | incidents | 0.75 | 0.00 | FAIL | The context provided does not contain any specific information about an incident prevented by the Re... |
...
| finnova-13-test-generator-agent | agents | 1.00 | 0.83 | PASS | The Test Generator agent (Agent 1) generates Playwright + TypeScript tests from user stories. Over 1... |
| finnova-14-rag-quality-gate | agents | 0.67 | 0.94 | PASS | Based on the provided context, **Agent 3 - RAG Quality Gate** is designed to:  > **Validate LLM-powe... |
...
| concept-02-prompt-injection-types | best-practices | 1.00 | 0.96 | PASS | Based on the provided context, the main categories of prompt injection attacks that QA should test f... |
| concept-03-rag-hallucination | best-practices | 0.98 | 0.96 | PASS | Based on the provided context, measuring and preventing hallucinations in RAG (Retrieval-Augmented G... |
| concept-04-page-object-model | best-practices | 0.95 | 0.80 | PASS | The **classic Page Object Model (POM)** tends to create large, monolithic page objects that encapsul... |
...
| concept-08-kafka-validation | best-practices | n/a | 0.94 | PASS | To test event-driven systems with Kafka in distributed environments, the context outlines a multi-la... |
