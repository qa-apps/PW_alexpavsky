...
_Generated: 2026-08-28T01:52:58.806272+00:00_
...
|---|---|---|---|
| Average faithfulness    | 0.960 | ≥ 0.65 | PASS |
| Average answer_relevancy | 0.832 | ≥ 0.55 | PASS |
...
| finnova-03-cost-savings | metrics | 1.00 | 0.86 | PASS | FinNova saved an estimated $2.4 million annually in operating costs compared to the December 2024 ba... |
...
| finnova-06-flake-rate | metrics | 0.40 | 0.00 | FAIL | The context provided does not contain specific information about flake rates before and after any en... |
...
| concept-03-rag-hallucination | best-practices | 1.00 | 0.96 | FAIL | To measure and prevent hallucinations in RAG (Retrieval-Augmented Generation) systems, the document ... |
| concept-06-mcp-architecture | best-practices | 1.00 | n/a | PASS | The Model Context Protocol (MCP) is an architecture designed to facilitate the interaction between l... |
| concept-09-ci-quality-gates | best-practices | 1.00 | 1.00 | FAIL | For AI/LLM features in CI/CD pipelines, the following quality gates should be in place:  1. **Datase... |
