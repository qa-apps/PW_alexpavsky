...
_Generated: 2026-05-28T05:08:12.558204+00:00_
...
|---|---|---|---|---|---|
| finnova-01-agent-count | facts | 1.00 | 0.98 | PASS | 7 specialized AI agents were deployed at FinNova Bank. These agents were:  1. Test Generator 2. Test... |
...
| finnova-10-black-friday | incidents | n/a | 0.95 | PASS | The Black Friday wire transfer outage in November 2024 caused 3 hours and 22 minutes of degraded ser... |
| finnova-11-march-incident | incidents | n/a | 0.00 | FAIL | The provided context does not contain any specific information about an incident prevented by the Re... |
...
| finnova-13-test-generator-agent | agents | 0.57 | 0.69 | PASS | The **Test Generator** agent (Agent 1) is responsible for creating automated tests from user stories... |
...
| concept-02-prompt-injection-types | best-practices | 1.00 | 1.00 | PASS | The main categories of prompt injection attacks that QA should test for, as outlined in the context,... |
| concept-03-rag-hallucination | best-practices | n/a | 0.96 | PASS | Based on the provided context, here’s how you can measure and prevent hallucinations in RAG systems:... |
| concept-04-page-object-model | best-practices | 0.88 | 0.85 | PASS | The **classic Page Object Model (POM)** tends to centralize all interactions and locators for an ent... |
