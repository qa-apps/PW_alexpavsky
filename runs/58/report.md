...
_Generated: 2026-07-04T18:50:11.761198+00:00_
...
| Average answer_relevancy | 0.758 | ≥ 0.55 | PASS |
...
| finnova-10-black-friday | incidents | 1.00 | 0.86 | PASS | During the Black Friday wire transfer outage in November 2024, approximately $14.7 million in transf... |
...
| finnova-13-test-generator-agent | agents | 0.75 | 1.00 | PASS | The **Test Generator** agent is responsible for generating automated test cases from user stories. S... |
| finnova-14-rag-quality-gate | agents | 0.50 | 0.97 | PASS | Agent 3 - RAG Quality Gate is designed to validate LLM-powered customer support responses against th... |
...
| concept-04-page-object-model | best-practices | 1.00 | 0.98 | PASS | The key difference between the **classic Page Object Model (POM)** and the **Component-Driven Page O... |
| concept-05-llm-judge-principles | best-practices | 1.00 | 1.00 | FAIL | Based on the provided context, the key principles when designing **LLM-as-a-Judge evaluation framewo... |
...
| concept-10-red-teaming-methodology | best-practices | 1.00 | 0.83 | PASS | The methodology for AI red teaming, as described in the provided context, involves systematically ta... |
