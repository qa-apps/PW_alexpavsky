...
_Generated: 2026-07-09T19:23:04.187766+00:00_
...
|---|---|---|---|
| Average faithfulness    | 0.879 | ≥ 0.65 | PASS |
| Average answer_relevancy | 0.750 | ≥ 0.55 | PASS |
...
|---|---|---|---|---|---|
| finnova-01-agent-count | facts | 1.00 | 0.97 | PASS | Seven specialized AI agents were deployed at FinNova Bank. These agents included:  1. Test Generator... |
...
| finnova-11-march-incident | incidents | 0.50 | 0.00 | FAIL | The context does not provide specific information about an incident prevented by the Red Team Bot on... |
...
| finnova-13-test-generator-agent | agents | 0.60 | 0.69 | PASS | The **Test Generator** agent (Agent 1) is responsible for generating automated tests from user stori... |
| finnova-14-rag-quality-gate | agents | 0.57 | 0.95 | PASS | Agent 3 - RAG Quality Gate is designed to validate LLM-powered customer support responses against th... |
...
| concept-03-rag-hallucination | best-practices | 0.89 | 0.96 | PASS | Based on the provided context, measuring and preventing hallucinations in RAG (Retrieval-Augmented G... |
| concept-04-page-object-model | best-practices | 0.72 | 0.95 | PASS | The **classic Page Object Model (POM)** tends to create large, monolithic page objects that encapsul... |
...
| concept-09-ci-quality-gates | best-practices | 0.83 | 0.99 | PASS | Based on the provided context, here are the recommended **quality gates** for AI/LLM features in CI/... |
