...
_Generated: 2026-06-19T18:28:53.141826+00:00_
...
|---|---|---|---|
| Average faithfulness    | 0.877 | ≥ 0.65 | PASS |
| Average answer_relevancy | 0.776 | ≥ 0.55 | PASS |
...
| finnova-02-bug-reduction | metrics | 1.00 | 0.95 | PASS | The production bugs at FinNova Bank dropped by **67%**.  (Before: 18.4 P1/P2 incidents per month → A... |
...
| finnova-08-transaction-volume | facts | n/a | n/a | PASS | The annual transaction volume of FinNova Bank is **$48 billion**.... |
...
| finnova-13-test-generator-agent | agents | 0.57 | 0.94 | PASS | The **Test Generator** agent (Agent 1) is responsible for **generating automated tests** from user s... |
| finnova-14-rag-quality-gate | agents | 0.40 | 1.00 | PASS | Agent 3 - RAG Quality Gate is designed to validate LLM-powered customer support responses against th... |
...
| concept-03-rag-hallucination | best-practices | 0.81 | 0.96 | PASS | To measure and prevent hallucinations in RAG (Retrieval-Augmented Generation) systems, the context e... |
| concept-04-page-object-model | best-practices | 1.00 | 0.98 | PASS | The **classic Page Object Model (POM)** tends to create large, monolithic page objects that encapsul... |
| concept-05-llm-judge-principles | best-practices | 1.00 | 1.00 | PASS | Based on the provided context, here are the key principles for designing LLM-as-a-Judge evaluation f... |
| concept-06-mcp-architecture | best-practices | 1.00 | 0.95 | PASS | The **Model Context Protocol (MCP)** is an open-standard architecture designed to standardize contex... |
| concept-07-flakiness-reduction | best-practices | 1.00 | 0.99 | PASS | Based on the provided context, the most effective strategies for reducing test flakiness in Playwrig... |
| concept-08-kafka-validation | best-practices | 0.82 | 1.00 | PASS | To test event-driven systems with Kafka in distributed environments, the context outlines a multi-la... |
