...
_Generated: 2026-06-23T18:32:11.143691+00:00_
...
|---|---|---|---|
| Average faithfulness    | 0.895 | ≥ 0.65 | PASS |
| Average answer_relevancy | 0.739 | ≥ 0.55 | PASS |
...
| finnova-05-test-cases | facts | 1.00 | n/a | PASS | The Test Generator agent (Agent 1) produced **3,247 automated test cases** over 12 months.  *(Source... |
...
| finnova-10-black-friday | incidents | 1.00 | 0.95 | PASS | During the Black Friday wire transfer outage in November 2024, the incident caused 3 hours and 22 mi... |
| finnova-11-march-incident | incidents | 0.75 | 0.00 | FAIL | The context does not provide specific information about an incident prevented by the Red Team Bot on... |
| finnova-12-kafka-incident | incidents | 0.00 | 0.00 | FAIL | The provided context does not contain any information about events, incidents, or findings from May ... |
| finnova-13-test-generator-agent | agents | 1.00 | 0.71 | PASS | The Test Generator agent (Agent 1) generates Playwright + TypeScript tests from user stories. Over 1... |
| finnova-14-rag-quality-gate | agents | 1.00 | 0.88 | PASS | Based on the provided context, **Agent 3 - RAG Quality Gate** is designed to:  > **Validate LLM-powe... |
...
| concept-04-page-object-model | best-practices | 0.92 | 0.73 | PASS | The **classic Page Object Model (POM)** collapses under complex Single Page Applications (SPAs) beca... |
| concept-05-llm-judge-principles | best-practices | 0.99 | 1.00 | PASS | Based on the provided context, the key principles when designing **LLM-as-a-Judge evaluation framewo... |
...
| concept-08-kafka-validation | best-practices | 0.98 | 0.99 | PASS | To test event-driven systems with Kafka in distributed environments, you need a **multi-layered test... |
| concept-09-ci-quality-gates | best-practices | 0.92 | 0.96 | PASS | Based on the provided context, here are the key **quality gates** that should be in place for AI/LLM... |
| concept-10-red-teaming-methodology | best-practices | 0.91 | 0.90 | PASS | The methodology for AI red teaming, as described in the provided context, focuses on systematically ... |
