...
_Generated: 2026-07-28T19:05:18.369002+00:00_
...
|---|---|---|---|
| Average faithfulness    | 0.922 | ≥ 0.65 | PASS |
...
| finnova-10-black-friday | incidents | 1.00 | 0.99 | PASS | During the Black Friday wire transfer outage in November 2024, approximately $14.7 million in transf... |
...
| finnova-13-test-generator-agent | agents | 0.67 | 0.63 | PASS | The **Test Generator** agent (Agent 1) is responsible for **automating the creation of test cases** ... |
| finnova-14-rag-quality-gate | agents | 0.92 | 0.99 | PASS | Based on the provided context, **Agent 3 - RAG Quality Gate** is designed to:  **Validate LLM-powere... |
...
| concept-04-page-object-model | best-practices | 0.79 | 0.97 | PASS | The **classic Page Object Model (POM)** tends to centralize all interactions and assertions for an e... |
| concept-05-llm-judge-principles | best-practices | 1.00 | 1.00 | PASS | The key principles when designing **LLM-as-a-Judge evaluation frameworks** are:  1. **Separate Evalu... |
