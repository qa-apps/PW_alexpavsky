...
_Generated: 2026-07-03T18:58:45.192875+00:00_
...
|---|---|---|---|
| Average faithfulness    | 0.907 | ≥ 0.65 | PASS |
| Average answer_relevancy | 0.746 | ≥ 0.55 | PASS |
...
| finnova-02-bug-reduction | metrics | 1.00 | 0.89 | PASS | According to the provided context, production bugs at FinNova Bank dropped by **67%** after the QA t... |
...
| finnova-12-kafka-incident | incidents | n/a | 0.00 | FAIL | The provided context does not contain any information about events, incidents, or findings dated May... |
| finnova-13-test-generator-agent | agents | n/a | 0.84 | PASS | The **Test Generator** agent (Agent 1) is responsible for generating automated tests from user stori... |
| finnova-14-rag-quality-gate | agents | 0.43 | 0.84 | PASS | Agent 3 - RAG Quality Gate is designed to validate LLM-powered customer support responses against th... |
...
| concept-03-rag-hallucination | best-practices | 0.75 | 0.96 | PASS | Based on the provided context, hallucinations in RAG (Retrieval-Augmented Generation) systems are ad... |
| concept-04-page-object-model | best-practices | 0.95 | 0.89 | PASS | The **classic Page Object Model (POM)** tends to create large, monolithic page objects that encapsul... |
...
| concept-06-mcp-architecture | best-practices | 1.00 | 0.91 | PASS | The **Model Context Protocol (MCP)** is an open-standard architecture designed to standardize contex... |
...
| concept-08-kafka-validation | best-practices | 0.97 | 0.93 | PASS | To test event-driven systems with Kafka in distributed environments, the provided context outlines a... |
