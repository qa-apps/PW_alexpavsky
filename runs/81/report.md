...
_Generated: 2026-07-27T19:10:08.617929+00:00_
...
| Average answer_relevancy | 0.761 | ≥ 0.55 | PASS |
...
|---|---|---|---|---|---|
| finnova-01-agent-count | facts | 0.90 | 1.00 | PASS | According to the context, 7 specialized AI agents were deployed at FinNova Bank.   Here is the list ... |
| finnova-02-bug-reduction | metrics | 1.00 | 0.99 | PASS | Based on the provided context, production bugs at FinNova Bank dropped by **67%**.  (Before: 18.4 P1... |
| finnova-03-cost-savings | metrics | 1.00 | 0.99 | PASS | According to the context, FinNova saved **$2.4 million annually** in operating costs.... |
...
| finnova-13-test-generator-agent | agents | 0.75 | 0.94 | PASS | The **Test Generator** agent is responsible for creating automated tests from user stories. Specific... |
| finnova-14-rag-quality-gate | agents | 0.33 | 0.98 | PASS | Based on the provided context, **Agent 3 - RAG Quality Gate** is designed to:  > **Validate LLM-powe... |
...
| concept-02-prompt-injection-types | best-practices | 1.00 | 0.81 | PASS | Based on the provided context, the main categories of prompt injection attacks that QA should test f... |
| concept-03-rag-hallucination | best-practices | 0.53 | 0.96 | PASS | To measure and prevent hallucinations in RAG (Retrieval-Augmented Generation) systems, the context e... |
...
| concept-08-kafka-validation | best-practices | 1.00 | 0.88 | PASS | To test event-driven systems with Kafka in distributed environments, the context outlines a **multi-... |
...
| negative-02-fabrication | refusal | 1.00 | 0.00 | PASS | Based on the provided context, the number of employees from Anthropic who worked on the FinNova enga... |