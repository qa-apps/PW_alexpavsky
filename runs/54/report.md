...
_Generated: 2026-06-30T18:29:51.187186+00:00_
...
|---|---|---|---|
| Average faithfulness    | 0.872 | ≥ 0.65 | PASS |
...
| finnova-13-test-generator-agent | agents | 0.40 | 0.85 | PASS | The **Test Generator** agent (Agent 1) is responsible for **automatically generating Playwright + Ty... |
| finnova-14-rag-quality-gate | agents | 0.91 | 0.90 | PASS | Agent 3 - RAG Quality Gate is designed to validate LLM-powered customer support responses against th... |
...
| concept-03-rag-hallucination | best-practices | 0.90 | 0.96 | PASS | Based on the provided context, measuring and preventing hallucinations in RAG (Retrieval-Augmented G... |
...
| concept-08-kafka-validation | best-practices | 1.00 | 0.95 | PASS | To test event-driven systems with Kafka in distributed environments, the context outlines a **multi-... |
| concept-09-ci-quality-gates | best-practices | 1.00 | 0.97 | PASS | Based on the provided context, here are the key **quality gates** that should be in place for AI/LLM... |
