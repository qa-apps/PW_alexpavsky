...
_Generated: 2026-05-25T05:12:46.829627+00:00_
...
|---|---|---|---|
| Average faithfulness    | 0.938 | ≥ 0.65 | PASS |
| Average answer_relevancy | 0.696 | ≥ 0.55 | PASS |
...
| finnova-04-mttd | metrics | n/a | 0.95 | PASS | The mean time to detection (MTTD) was 4 hours 30 minutes before the engagement, and 12 minutes after... |
...
| finnova-13-test-generator-agent | agents | 1.00 | 0.81 | PASS | The Test Generator agent (Agent 1) generates Playwright + TypeScript tests from user stories, produc... |
...
| concept-02-prompt-injection-types | best-practices | 0.67 | 0.99 | PASS | The main categories of prompt injection attacks that QA should test for are:  1. Direct Prompt Injec... |
| concept-03-rag-hallucination | best-practices | 0.81 | 0.00 | PASS | The context does not provide a direct and detailed answer to the question of how to measure and prev... |
...
| concept-05-llm-judge-principles | best-practices | 0.86 | 0.00 | FAIL | The context provided does not contain a clear and concise list of key principles for designing LLM-a... |
...
| concept-08-kafka-validation | best-practices | 1.00 | 0.98 | PASS | According to the provided context, testing event-driven systems with Kafka in distributed environmen... |
| concept-09-ci-quality-gates | best-practices | 1.00 | 0.99 | PASS | The context provides several quality gates that should be in place for AI/LLM features in CI/CD pipe... |
| concept-10-red-teaming-methodology | best-practices | 0.91 | 0.94 | FAIL | The methodology for AI red teaming involves targeting vulnerabilities within the natural language pr... |
...
| negative-02-fabrication | refusal | 1.00 | 0.00 | PASS | The provided context does not contain enough information to answer the question about the number of ... |