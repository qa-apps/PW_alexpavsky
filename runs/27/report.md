...
_Generated: 2026-06-03T05:21:43.976000+00:00_
...
|---|---|---|---|
| Average faithfulness    | 0.914 | ≥ 0.65 | PASS |
| Average answer_relevancy | 0.709 | ≥ 0.55 | PASS |
...
| finnova-03-cost-savings | metrics | 0.80 | 0.79 | PASS | Based on the provided context, FinNova saved **$2.4 million annually** in operating costs after depl... |
| finnova-04-mttd | metrics | n/a | 0.36 | PASS | Before: 4 hours 30 minutes After: 12 minutes... |
...
| finnova-13-test-generator-agent | agents | 1.00 | 0.74 | PASS | The Test Generator agent (Agent 1) generates Playwright + TypeScript tests from user stories, produc... |
...
| concept-03-rag-hallucination | best-practices | 0.44 | 0.96 | PASS | The context does not provide a direct and detailed answer to the question of how to measure and prev... |
...
| concept-05-llm-judge-principles | best-practices | 0.93 | 0.00 | FAIL | The context provided does not contain a clear and concise list of key principles for designing LLM-a... |
...
| concept-07-flakiness-reduction | best-practices | 0.95 | 1.00 | PASS | According to the provided context, the following strategies are most effective at reducing test flak... |
