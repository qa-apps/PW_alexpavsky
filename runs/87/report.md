...
_Generated: 2026-08-02T18:49:07.590193+00:00_
...
|---|---|---|---|
| Average faithfulness    | 0.969 | ≥ 0.65 | PASS |
| Average answer_relevancy | 0.754 | ≥ 0.55 | PASS |
...
| finnova-10-black-friday | incidents | 1.00 | 0.83 | PASS | During the Black Friday wire transfer outage in November 2024, the FinNova Bank system experienced 3... |
| finnova-11-march-incident | incidents | 0.50 | 0.00 | FAIL | The provided context does not contain information about a specific incident prevented by the Red Tea... |
...
| finnova-13-test-generator-agent | agents | 1.00 | 0.96 | PASS | The **Test Generator** agent is responsible for creating automated tests from user stories. Specific... |
...
| finnova-15-red-team-vulns | agents | 1.00 | 0.98 | PASS | The **Red Team Bot** caught **47 high-severity vulnerabilities** before production. This is mentione... |
...
| concept-03-rag-hallucination | best-practices | 1.00 | 0.96 | PASS | To measure and prevent hallucinations in **RAG (Retrieval-Augmented Generation) systems**, the conte... |
| concept-04-page-object-model | best-practices | 0.93 | 0.83 | PASS | The **classic Page Object Model (POM)** tends to collapse under complex Single Page Applications (SP... |
...
| concept-08-kafka-validation | best-practices | 0.96 | 0.96 | PASS | To test event-driven systems with Kafka in distributed environments, the context outlines a **multi-... |
| concept-09-ci-quality-gates | best-practices | 1.00 | 0.93 | PASS | The context provides several quality gates that should be in place for AI/LLM features in CI/CD pipe... |
| concept-10-red-teaming-methodology | best-practices | 1.00 | 0.86 | PASS | The methodology for AI red teaming, as outlined in the provided context, focuses on systematically t... |
