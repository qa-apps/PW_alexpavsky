...
_Generated: 2026-07-08T19:07:56.462913+00:00_
...
|---|---|---|---|
| Average faithfulness    | 0.944 | ≥ 0.65 | PASS |
...
| finnova-03-cost-savings | metrics | 0.83 | 0.81 | PASS | Based on the provided context, FinNova saved **$2.4 million annually** in operating costs after depl... |
...
| finnova-06-flake-rate | metrics | 1.00 | 0.00 | FAIL | The context does not provide specific flake rate metrics before and after the engagement. It mention... |
...
| finnova-10-black-friday | incidents | 1.00 | 1.00 | PASS | During the Black Friday wire transfer outage in November 2024, 6 of the 9 contributing defects were ... |
...
| finnova-12-kafka-incident | incidents | 1.00 | 0.00 | FAIL | The provided context does not contain any information about a "Data Integrity Verifier" or any event... |
| finnova-13-test-generator-agent | agents | 1.00 | 0.68 | PASS | The **Test Generator** agent (Agent 1) is responsible for generating automated test cases from user ... |
| finnova-14-rag-quality-gate | agents | 1.00 | 1.00 | PASS | Agent 3 - **RAG Quality Gate** is designed to validate LLM-powered customer support responses agains... |
...
| concept-03-rag-hallucination | best-practices | n/a | 0.96 | PASS | To measure and prevent hallucinations in RAG (Retrieval-Augmented Generation) systems, the context e... |
...
| concept-07-flakiness-reduction | best-practices | 0.69 | 1.00 | PASS | Based on the provided context, the most effective strategies for reducing test flakiness in Playwrig... |
...
| concept-09-ci-quality-gates | best-practices | 0.74 | 0.98 | PASS | Based on the provided context, here are the key **quality gates** that should be in place for AI/LLM... |
| concept-10-red-teaming-methodology | best-practices | 1.00 | 0.75 | PASS | The methodology for AI red teaming, as described in the provided context, involves systematically ta... |
...
| negative-02-fabrication | refusal | 0.33 | 0.00 | PASS | Based on the provided context, the number of employees from Anthropic who worked on the FinNova enga... |