...
_Generated: 2026-06-02T05:16:23.887572+00:00_
...
|---|---|---|---|
| Average faithfulness    | 0.937 | ≥ 0.65 | PASS |
...
| finnova-02-bug-reduction | metrics | 1.00 | 0.98 | PASS | The production bugs at FinNova Bank dropped by **67%**.  (Before: 18.4 P1/P2 incidents per month; Af... |
| finnova-03-cost-savings | metrics | 0.75 | 0.80 | PASS | Based on the provided context, FinNova saved **$2.4 million annually** in operating costs after depl... |
...
| finnova-10-black-friday | incidents | 1.00 | 0.98 | PASS | During the Black Friday wire transfer outage in November 2024, there was a 3-hour 22-minute period o... |
...
| finnova-12-kafka-incident | incidents | 1.00 | 0.00 | FAIL | The context provided does not contain any information about an event or incident that occurred on Ma... |
| finnova-13-test-generator-agent | agents | 0.71 | 0.79 | PASS | The **Test Generator** agent (Agent 1) is responsible for generating automated tests from user stori... |
| finnova-14-rag-quality-gate | agents | 0.75 | 1.00 | PASS | Agent 3 - RAG Quality Gate is designed to validate LLM-powered customer support responses against th... |
...
| concept-04-page-object-model | best-practices | 0.79 | 0.86 | PASS | The **classic Page Object Model (POM)** tends to centralize all interactions and locators for an ent... |
...
| concept-08-kafka-validation | best-practices | n/a | 0.84 | PASS | To test event-driven systems with Kafka in distributed environments, the context outlines a **multi-... |
...
| concept-10-red-teaming-methodology | best-practices | n/a | 0.92 | PASS | The methodology for AI red teaming, as outlined in the provided context, involves systematically tar... |
