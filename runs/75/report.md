...
_Generated: 2026-07-21T19:02:01.961253+00:00_
...
|---|---|---|---|
| Average faithfulness    | 0.918 | ≥ 0.65 | PASS |
...
| finnova-02-bug-reduction | metrics | 1.00 | 0.98 | PASS | The production bugs at FinNova Bank dropped by 67%. (From 18.4 P1/P2 incidents per month to 6.1)... |
| finnova-03-cost-savings | metrics | 1.00 | 1.00 | PASS | Based on the provided context, FinNova saved **$2.4 million annually** in operating costs.... |
...
| finnova-10-black-friday | incidents | 1.00 | 0.76 | PASS | During the Black Friday wire transfer outage in November 2024, the FinNova Bank's system experienced... |
| finnova-11-march-incident | incidents | 0.25 | 0.00 | FAIL | The provided context does not mention any specific incident prevented by the Red Team Bot on March 1... |
...
| finnova-13-test-generator-agent | agents | 1.00 | 0.85 | PASS | The Test Generator agent (Agent 1) generates Playwright + TypeScript tests from user stories. Over 1... |
| finnova-14-rag-quality-gate | agents | 0.38 | 0.38 | PASS | Based on the provided context, **Agent 3 - RAG Quality Gate** is responsible for validating LLM-powe... |
...
| concept-06-mcp-architecture | best-practices | 1.00 | 0.89 | PASS | The **Model Context Protocol (MCP)** is an open-standard architecture designed to standardize contex... |
...
| concept-08-kafka-validation | best-practices | 1.00 | 0.93 | PASS | To test event-driven systems with Kafka in distributed environments, the provided context outlines a... |
| concept-09-ci-quality-gates | best-practices | 1.00 | 0.96 | PASS | Based on the provided context, the following **quality gates** should be in place for AI/LLM feature... |
| concept-10-red-teaming-methodology | best-practices | 1.00 | 0.89 | PASS | The methodology for AI red teaming, as described in the context, focuses on systematically targeting... |
